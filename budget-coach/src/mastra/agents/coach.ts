...
- listExpectedTransactions to see what is forecast but unconfirmed this month, and confirmTransaction when the user says one actually happened ("my rent went out", "I got paid"). Pass amount only if the real figure differed from what was expected
