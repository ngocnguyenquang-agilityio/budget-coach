...
/**
 * Redirects to a freshly-created thread route (`/{rootPath}/{agentId}/chat/{uuid}?new=true`)
 * so message-persisting pages always mount with a stable, shareable thread id.
 */
function NewThreadRedirect({
  ...
  return <Navigate to={newThreadLink(rootPath, agentId)} replace />;
}
            ...
            <Layout>
              <Routes>
                <Route
                  ...
                  index
                  element={
                    <NewThreadRedirect rootPath="ai-sdk" agentId="ghibliAgent" />
                  }
                />
                <Route path="/ai-sdk">
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <NewThreadRedirect
                        ...
                        agentId="ck_agentic_chat"
                      />
                    }
                  />
                  <Route
                    path=":agentId/chat/:threadId"
                    element={<ChatCopilotKit />}
                  />
                  <Route
                    path="generative-user-interfaces"
                ...
                <Route path="/mastra-client-sdk">
                  ...
                  <Route
                    path=":agentId/chat/:threadId"
                    element={<MastraClientAgentStream />}
                  />
                  <Route
                    path="json-render"
