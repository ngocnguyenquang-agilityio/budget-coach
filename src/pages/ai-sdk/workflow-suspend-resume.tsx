...
const suggestions: RequestSuggestion[] = [
  {
    title: "Expense: $500 monitor",
    requestType: "Expense",
    amount: "500",
    details: "New monitor for design team",
  },
  {
    title: "Vacation: 5 days",
    requestType: "Vacation",
    amount: "",
    details: "5 days off for a family trip",
  },
  {
    title: "Purchase: $1200 laptop",
    requestType: "Purchase",
    amount: "1200",
    details: "Replacement laptop for engineering",
  },
];
...
const WorkflowSuspendResumeDemo = () => {
  ...
  const handleSuggestionClick = (suggestion: RequestSuggestion) => {
    if (!canStart) return;
