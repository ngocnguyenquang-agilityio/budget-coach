...
const suggestions: OrderSuggestion[] = [
  {
    title: "2x ABC123 for $29.99",
    productId: "ABC123",
    quantity: "2",
    amount: "29.99",
  },
  {
    title: "5x XYZ789 for $99.50",
    productId: "XYZ789",
    quantity: "5",
    amount: "99.50",
  },
...
const SubAgentsAndWorkflowsCustomEventsDemo = () => {
  ...
  const handleSuggestionClick = (suggestion: OrderSuggestion) => {
    if (status !== "ready") return;
    const orderMessage = `Place an order for product ${suggestion.productId}, quantity ${suggestion.quantity}, amount ${suggestion.amount}`;
    sendMessage({ text: orderMessage });
    setProductId("");
    setQuantity("");
    setAmount("");
