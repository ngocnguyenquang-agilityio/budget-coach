...
// one per browser here. Without this, working memory (temperature
// preference), thread listings, and any future semantic recall would be
// shared across everyone hitting the app instead of scoped to the person
// using it.
