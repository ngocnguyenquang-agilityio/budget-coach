...
const suggestions: OrderSuggestion[] = [
  {
    title: "Standard order ORD-12345",
    orderId: "ORD-12345",
    amount: "49.99",
    orderType: "standard",
  },
  {
    title: "Express order ORD-98765",
    orderId: "ORD-98765",
    amount: "149.50",
    orderType: "express",
  },
...
const WorkflowCustomEventsDemo = () => {
  ...
  const handleSuggestionClick = (suggestion: OrderSuggestion) => {
    ...
    setOrderType(suggestion.orderType);
    sendMessage({
      text: `Process ${suggestion.orderType} order ${suggestion.orderId}`,
      metadata: {
